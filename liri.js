...
//the key to use OMDB
//var omdbKey = "40e9cece"; I ended up not using this variable
	...
	twitter.get("statuses/user_timeline", myTweets, function(error, tweets, response){
		...
		if(error) {
			...
			for (var h = 0; h < tweets.length; h++) {
				...
				//console.log(JSON.stringify(tweets, null, 2)); saving for reference.
			}
